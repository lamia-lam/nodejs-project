        ...
        <div className="px-4">
          ...
          <div className="row g-4 mb-4">
            <div className="col-md-4">
              ...
              >
                <div className="text-muted mb-2">Today's Prescribed</div>
            ...
            <div className="col-md-4">
              <div
                ...
                style={{ backgroundColor: "#f6f7f8" }}
              >
                <div className="text-muted mb-2">Today's Target</div>
                <div className="fw-bold" style={{ fontSize: "28px" }}>
                  32
                </div>
              </div>
            ...
            <div className="col-md-4">
              <div
                ...
                style={{ backgroundColor: "#f6f7f8" }}
              >
                <div className="text-muted mb-2">Target Fulfilled</div>
                <div className="fw-bold" style={{ fontSize: "28px" }}>
                  60%
                </div>
              </div>
          ...
          {/* Recent Activity */}
          <div className="mb-3 fw-bold" style={{ fontSize: "20px" }}>
            Recent Activity
          </div>
